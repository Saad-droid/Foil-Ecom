    ...
    <footer className="footer__section footer__bg">
      <div className="container">
        <div className="footer__top">
          <div className="row main__footer--wrapper footer__top--row">
            <div className="col-lg-3 footer__col--width col-md-7 footer__col--padding footer__col--order">
              <div className="footer__widget">
                <h3 className="footer__widget--title sm__footer--widget__bock">About Us
                ...
                <div className="footer__widget--inner">
                  <h3 className="footer__widget--title">Why Choose Us?
                    <button className="footer__widget--button" aria-label="footer widget button">
                      <svg className="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                        <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                      </svg>
                  ...
                  <ul className="footer__widget--social d-flex">
                    <li className="footer__widget--social__list">
                      <a className="footer__widget--social__icon" target="_blank" href="#">
            ...
            <div className="col-lg-2 footer__col--width col-md-4 footer__col--padding">
              <div className="footer__widget">
                <h3 className="footer__widget--title">Category
                  <button className="footer__widget--button" aria-label="footer widget button">
                    <svg className="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                      <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                    </svg>
                ...
                <ul className="footer__widget--menu footer__widget--inner">
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Hot Stamping Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Garment Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Wood Grain Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Rexine Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Digital Foil</Link>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-2 footer__col--width col-md-4 footer__col--padding">
              <div className="footer__widget">
                ...
                <ul className="footer__widget--menu footer__widget--inner">
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">Cold Stamping Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">MGI Foil</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/shop">TAG Foil</Link>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-2 footer__col--width col-md-4 footer__col--padding">
              <div className="footer__widget">
                ...
                <ul className="footer__widget--menu footer__widget--inner">
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/">Home</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/about">About Us</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/video-gallery">Video Gallery</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/be-an-agent">Be An Agent</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/blog">Blog</Link>
                  </li>
                  <li className="footer__widget--menu__list">
                    <Link className="footer__widget--menu__text" to="/contact">Contact Us</Link>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3 col-md-5 footer__col--padding footer__col--order">
              <div className="footer__widget">
                <h3 className="footer__widget--title">Contact Us
                  <button className="footer__widget--button" aria-label="footer widget button">
                    <svg className="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                      <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                    </svg>
            ...
            <div className="col-12 col-md-auto">
              <div className="footer__payment">
                <ul className="footer__payment--inner d-flex">
                  ...
                  <li className="footer__payment--list">
                    <a href="shipping-payment-policy.php">Shipping &amp; Payment Policy</a>
                  </li>
                </ul>
              </div>
            </div>
